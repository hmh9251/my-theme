...
- **字符串**:深紫 `#6F42C1`(v0.9),舒适且与关键字、函数、对象键名明显区分
- **对象键名**:蓝灰 `#0B7CAD`(v0.8/v0.8.1),部分 grammar 下生效
...
```powershell
code --install-extension dawn-owl-0.9.0.vsix --force
```
...
- `0.9.0` 字符串色改为深紫 `#6F42C1`,不再与对象键名/关键字混淆
